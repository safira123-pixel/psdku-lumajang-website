...
import NewsCard from "../../components/NewsCard_kegiatanMahasiswa";
            ...
            <Card className={classes.card}>
              <div className={classes.container}>
                <Breadcrumb style={{ marginTop: "10px" }}>
                  ...
                  <Breadcrumb.Item active href="/kegiatan_mahasiswa">
                    {" "}
                    {t("Kegiatan Mahasiswa")}
                  </Breadcrumb.Item>
                </Breadcrumb>
...
export default withRoot(
  withStyles(styles)(withTranslation()(kegiatan_mahasiswa))
);
