            ...
            <Card className={classes.card}>
              <div className={classes.container}>
                <Breadcrumb style={{ marginTop: "10px" }}>
                  ...
                  <Breadcrumb.Item active href="/kegiatan_mahasiswa3">
                    {" "}
                    {t("Kegiatan Mahasiswa")}
                  </Breadcrumb.Item>
                </Breadcrumb>
              ...
              <Grid item className={classes.gridItemFix} xs={12} sm={4} lg={9}>
                {data.map((item, index) => (
                  <NewsCard
                    ...
                    link1={"/item_kegiatan7"}
                    content1={t("Selengkapnya")}
                    data1={item[6].data}
                    nama1={item[6].name}
                    deskripsi1={item[6].selengkapnya}
                    link2={"/item_kegiatan8"}
                    content2={t("Selengkapnya")}
                    data2={item[7].data}
                    nama2={item[7].name}
                    deskripsi2={item[7].selengkapnya}
                    link3={"/item_kegiatan9"}
                    content3={t("Selengkapnya")}
                    data3={item[8].data}
                    nama3={item[8].name}
                    deskripsi3={item[8].selengkapnya}
                  />
                ))}
              </Grid>
...
export default withRoot(
  withStyles(styles)(withTranslation()(kegiatan_mahasiswa3))
);
