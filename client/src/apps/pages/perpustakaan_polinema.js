                    ...
                    <div className={classes.container}>
                        ...
                        <Breadcrumb style={{marginTop:"10px"}}>
                            <Breadcrumb.Item href="/"> {t('beranda.label')}</Breadcrumb.Item>
                             <Breadcrumb.Item href="/perpustakaan_polinema"> {t('Perpustakaan PSDKU Polinema Kampus Lumajang')}</Breadcrumb.Item>
                             <Breadcrumb.Item href="/perpustakaan_polinema"> {t('Perpustakaan')}</Breadcrumb.Item>
                         </Breadcrumb>             
                    </div>
                </Card>
...
export default withRoot(withStyles(styles)(withTranslation()(perpustakaan_polinema)))
