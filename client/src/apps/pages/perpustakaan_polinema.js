...
const perpustakaan_polinema = (props) => {
            ...
            <Card className={classes.card}>
              <div className={classes.container}>
                <Breadcrumb style={{ marginTop: "10px" }}>
                  ...
                  <Breadcrumb.Item href="/perpustakaan_polinema">
                    {" "}
                    {t("Perpustakaan PSDKU Polinema Kampus Lumajang")}
                  </Breadcrumb.Item>
                  <Breadcrumb.Item href="/perpustakaan_polinema">
                    {" "}
                    {t("Perpustakaan")}
...
export default withRoot(
  withStyles(styles)(withTranslation()(perpustakaan_polinema))
);
