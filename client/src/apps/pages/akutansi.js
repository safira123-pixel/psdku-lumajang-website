            ...
            <Card className={classes.card}>
              <div className={classes.container}>
                <Breadcrumb style={{ marginTop: "10px" }}>
                  ...
                  <Breadcrumb.Item href="/akuntansi">
                    {" "}
                    {t("Program Studi")}
                  </Breadcrumb.Item>
                  <Breadcrumb.Item active href="/akuntansi">
                    {" "}
                    {t("Akuntansi")}
                  </Breadcrumb.Item>
                </Breadcrumb>
              ...
              <Grid item className={classes.gridItemFix} xs={12} sm={4} lg={9}>
                {data.map((item, index) => (
                  <NewsCard
                    ...
                    instagramLink={
                      <a
                        href="https://www.instagram.com/hmapolinema_psdkulmj/"
                        target="_blank"
...
export default withRoot(withStyles(styles)(withTranslation()(akuntansi)));
