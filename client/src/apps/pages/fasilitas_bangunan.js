        ...
        <Card className={classes.card}>
          <div className={classes.container}>
            <Breadcrumb style={{ marginTop: "10px" }}>
              ...
              <Breadcrumb.Item href="/fasilitas_bangunan">
                {" "}
                {t("Fasilitas Bangunan PSDKU Polinema Kampus Lumajang")}
              </Breadcrumb.Item>
              <Breadcrumb.Item href="/fasilitas_bangunan">
                {" "}
                {t("Fasilitas Bangunan")}
              </Breadcrumb.Item>
            </Breadcrumb>
          </div>
        </Card>
...
export default withRoot(
  withStyles(styles)(withTranslation()(fasilitas_bangunan))
);
