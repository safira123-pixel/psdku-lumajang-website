              ...
              <div className={classes.container}>
                {data.map((item, index) => (
                  <Breadcrumb key={index} style={{ marginTop: "10px" }}>
                    ...
                    <Breadcrumb.Item active href="/item_pengumuman3">
                      {" "}
                      {item[0].name}
                    </Breadcrumb.Item>
                  </Breadcrumb>
            ...
            <Grid container className={classes.contentContainer}>
              <Grid item className={classes.gridItemFix} xs={12} sm={4} lg={9}>
                {data.map((item, index) => (
                  <NewsCard
                    key={index}
                    profileName={item[5].name}
                    profileImg={item[5].data}
...
export default withRoot(
  withStyles(styles)(withTranslation()(item_pengumuman6))
);
