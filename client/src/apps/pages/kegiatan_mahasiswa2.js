              ...
              <Card className={classes.card}>
                    <div className={classes.container}>
                        <Breadcrumb style={{marginTop:"10px"}}>
                            ...
                            <Breadcrumb.Item active href="/kegiatan_mahasiswa2"> {t('Kegiatan Mahasiswa')}</Breadcrumb.Item>
                        </Breadcrumb>        
                    </div>
                </Card>
...
export default withRoot(withStyles(styles)(withTranslation()(kegiatan_mahasiswa2)))
