...
import NewsCard from "../../components/NewsCard_Kantin";
...
const kantin = (props) => {
  ...
  useEffect(() => {
    fetch(config.apiUrl + "/api/campus_life") // Pastikan URL endpoint sesuai
            ...
            <Card className={classes.card}>
              <div className={classes.container}>
                <Breadcrumb style={{ marginTop: "10px" }}>
                  ...
                  <Breadcrumb.Item href="/kantin">
                    {" "}
                    {t("Kantin PSDKU Polinema Kampus Lumajang")}
                  </Breadcrumb.Item>
                  <Breadcrumb.Item href="/kantin">
                    {" "}
                    {t("Kantin")}
...
export default withRoot(withStyles(styles)(withTranslation()(kantin)));
