                    ...
                    <div className={classes.container}>
                        ...
                        <Breadcrumb style={{marginTop:"10px"}}>
                            <Breadcrumb.Item href="/"> {t('beranda.label')}</Breadcrumb.Item>
                             <Breadcrumb.Item href="/fasilitas_parkir"> {t('Fasilitas Parkir PSDKU Polinema Kampus Lumajang')}</Breadcrumb.Item>
                             <Breadcrumb.Item href="/fasilitas_parkir"> {t('Fasilitas Parkir')}</Breadcrumb.Item>
                         </Breadcrumb>             
                    </div>
                </Card>
...
export default withRoot(withStyles(styles)(withTranslation()(fasilitas_parkir)))
