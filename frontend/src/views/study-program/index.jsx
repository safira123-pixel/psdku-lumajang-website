...
class StudyProgram extends Component {
  ...
  render() {
    ...
    const title = (
      <span>
        <Button type='primary' onClick={this.handleAddUser}>Tambahkan program studi</Button>
      </span>
    )
      ...
      <div className="app-container">
        ...
        <Card title={title}>
          <Table bordered rowKey="id" dataSource={users} pagination={false}>
            <Column title="ID Program Studi" dataIndex="id" key="id" align="center"/>
            <Column title="Jurusan" dataIndex="role" key="role" align="center"/>
            <Column title="Nama" dataIndex="name" key="name" align="center"/>
            <Column title="Deskripsi Program Studi" dataIndex="description" key="description" align="center" />
        ...
        <EditStudyProgramForm
          ...
          wrappedComponentRef={formRef => this.editStudyProgramFormRef = formRef}
        ...
        />  
        <AddStudyProgramForm
          wrappedComponentRef={formRef => this.addStudyProgramFormRef = formRef}
