...
public class Lecture extends UserDateAudit {
    ...
    public Lecture(Long id, User user, @Nullable Long nidn, String name, @Nullable String place_born, @Nullable Date date_born, @Nullable Boolean gender, Religion religion, @Nullable String phone, String address, @Nullable Boolean status) {
        this.id = id;
        this.user = user;
        this.nidn = nidn;
        this.name = name;
