...
class User extends Component {
   ...
   handleDeleteUser = (row) => {
     const { id } = row
     if (id === "admin") {
       message.error("Cannot delete administrator user!")
       return
     }
   ...
   render() {
     ...
     const cardContent = `Here, you can manage users in the system, such as adding a new user, or modifying existing users in the system. `
     return (
       <div className="app-container">
         ...
         <Card title={title}>
           <Table bordered rowKey="id" dataSource={users} pagination={false}>
             ...
             <Column title="Operation" key="action" width={195} align="center" render={(text, row) => (
               <span>
